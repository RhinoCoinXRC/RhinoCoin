...
contains(BRHINOCOIN_NEED_QT_PLUGINS, 1) {
    DEFINES += BRHINOCOIN_NEED_QT_PLUGINS
...
!windows|contains(USE_BUILD_INFO, 1) {
    ...
    genbuild.commands = cd $$PWD; /bin/sh share/genbuild.sh $$OUT_PWD/build/build.h;cp $$OUT_PWD/build/build.h $$OUT_PWD/src/build.h
...
contains(BRHINOCOIN_QT_TEST, 1) {
SOURCES += src/qt/test/test_main.cpp \
    src/qt/test/uritests.cpp
HEADERS += src/qt/test/uritests.h
DEPENDPATH += src/qt/test
QT += testlib
TARGET = RhinoCoin-qt_test
DEFINES += BRHINOCOIN_QT_TEST
}
...
macx:ICON = src/qt/res/icons/RhinoCoin.icns
macx:TARGET = "RhinoCoin-Qt"
