...
unsigned int nStakeMinAge = 60 * 60 * 24 * 3;	// minimum age for coin age: 3d
...
int64 nChainStartTime = 1401589790;
...
const string strMessageMagic = "RhinoCoin Signed Message:\n";
...
int64 GetProofOfWorkReward(int nHeight, int64 nFees, uint256 prevHash)
{
	...
	if(nHeight <= 10000)
	{
		nSubsidy = 2000 * COIN;	// 2000 coins per block for the first three days.
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "Activists raise pitch to stop rhino killings";
        CTransaction txNew;
        ...
        printf("block.nNonce = %u \n", block.nNonce);
			block.print();
        assert(block.hashMerkleRoot == uint256("0xf14f8f80898627bd45a9473047d8f852c833226805c878ac5a53d1ec7a4c502e"));
